...
public:
    ...
    void setupUi(QWidget *ParameterInput)
    {
        ...
        pushButton_Next->setGeometry(QRect(510, 450, 450, 70));
        DescriptionImg_1 = new QLabel(ParameterInput);
        DescriptionImg_1->setObjectName(QStringLiteral("DescriptionImg_1"));
        DescriptionImg_1->setGeometry(QRect(520, 9, 450, 250));
        DescriptionImg_1->setStyleSheet(QStringLiteral("background-color: rgb(239, 235, 231);"));
        ...
        DescriptionImg_2 = new QLabel(ParameterInput);
        DescriptionImg_2->setObjectName(QStringLiteral("DescriptionImg_2"));
        DescriptionImg_2->setGeometry(QRect(520, 280, 450, 150));
        DescriptionImg_2->setStyleSheet(QStringLiteral("background-color: rgb(239, 235, 231);"));
        Background->raise();
        pushButton_Prev->raise();
        pushButton_Next->raise();
        DescriptionImg_1->raise();
        layoutWidget->raise();
        DescriptionImg_2->raise();
    ...
    void retranslateUi(QWidget *ParameterInput)
    {
        ...
        DescriptionImg_1->setText(QString());
        ...
        DescriptionImg_2->setText(QString());
    } // retranslateUi
